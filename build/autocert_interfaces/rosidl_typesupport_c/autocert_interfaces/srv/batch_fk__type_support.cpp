...
static const _BatchFK_Request_type_support_symbol_names_t _BatchFK_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autocert_interfaces, srv, BatchFK_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autocert_interfaces, srv, BatchFK_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autocert_interfaces, srv, BatchFK_Request)() {
  return &::autocert_interfaces::srv::rosidl_typesupport_c::BatchFK_Request_message_type_support_handle;
}
...
static const _BatchFK_Response_type_support_symbol_names_t _BatchFK_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autocert_interfaces, srv, BatchFK_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autocert_interfaces, srv, BatchFK_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autocert_interfaces, srv, BatchFK_Response)() {
  return &::autocert_interfaces::srv::rosidl_typesupport_c::BatchFK_Response_message_type_support_handle;
}
...
static const _BatchFK_Event_type_support_symbol_names_t _BatchFK_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autocert_interfaces, srv, BatchFK_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autocert_interfaces, srv, BatchFK_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autocert_interfaces, srv, BatchFK_Event)() {
  return &::autocert_interfaces::srv::rosidl_typesupport_c::BatchFK_Event_message_type_support_handle;
}
...
static const _BatchFK_type_support_symbol_names_t _BatchFK_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autocert_interfaces, srv, BatchFK)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autocert_interfaces, srv, BatchFK)),
  }
};
...
static const rosidl_service_type_support_t BatchFK_service_type_support_handle = {
  ...
  &BatchFK_Request_message_type_support_handle,
  &BatchFK_Response_message_type_support_handle,
  &BatchFK_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autocert_interfaces, srv, BatchFK)() {
  return &::autocert_interfaces::srv::rosidl_typesupport_c::BatchFK_service_type_support_handle;
}
