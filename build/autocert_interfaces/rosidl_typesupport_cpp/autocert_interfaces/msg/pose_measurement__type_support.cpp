...
static const _PoseMeasurement_type_support_symbol_names_t _PoseMeasurement_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autocert_interfaces, msg, PoseMeasurement)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autocert_interfaces, msg, PoseMeasurement)),
  }
};
...
{
  return &::autocert_interfaces::msg::rosidl_typesupport_cpp::PoseMeasurement_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autocert_interfaces, msg, PoseMeasurement)() {
  return get_message_type_support_handle<autocert_interfaces::msg::PoseMeasurement>();
}
